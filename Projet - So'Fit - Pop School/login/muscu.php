...
<head>
  <title>Home</title>
  <meta charset="UTF-8">
  <link rel="stylesheet" href="CSS/muscu.css" />
...
<body>
  ...
  <div class="container">
        <div class="block" onclick="window.location.href='profile.php'">
            <h1>Niveau: Débutant</h1>
            <hr>
            <p>On commence tous par là</p>
        </div>
        <div class="block" onclick="window.location.href='profile.php'">
            <h1>Niveau: Intermédiaire</h1>
            <hr>
            <p>Quand on commence à se faire mal</p>
        </div>
        <div class="block" onclick="window.location.href='profile.php'">
            <h1>Niveau: Avancé</h1>
            <hr>
            <p>Quand on commence à se prendre au sérieux</p>
        </div>
        <div class="block" onclick="window.location.href='profile.php'">
            <h1>Niveau: Compétition</h1>
            <hr>
            <p>Pour les vrais guerriers de la salle de gym</p>
        </div>
    </div>
